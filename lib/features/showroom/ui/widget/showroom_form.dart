...
import 'package:sayer/features/showroom/logic/showroom_controller.dart';
...
import 'package:sayer/features/showroom/ui/widget/validation.dart';
...
class _ShowroomFormState extends State<ShowroomForm> {
  ...
  final controller = ShowroomController();
  ...
  void showCustomNotification(String message, IconData icon) {
      ...
      child: Column(
        children: [
          ...
          AppTextField(
            ...
            onFieldSubmitted:
                (_) => FocusScope.of(context).requestFocus(locationFocus),
          ),
          AppDropdownField(
